...
class DualDeepLearningGaMDEquilibration(CustomIntegrator):
    def __init__(self, dt_ps: float = 0.002, temperature_K: float = 300.0, params: BoostParams | None = None):
        ...
        self.addComputeGlobal("RawTotalBoostPotential", "0.5*Totalk0*(TotalRefEnergy-TotalEnergy)^2/max(VmaxP-VminP, %g)" % _EPS)
        self.addComputeGlobal("RawTotalForceScalingFactor", "1 - Totalk0*(TotalRefEnergy-TotalEnergy)/max(VmaxP-VminP, %g)" % _EPS)
        self.endBlock()
        self.beginIfBlock("TotalEnergy >= TotalRefEnergy")
        self.addComputeGlobal("RawTotalBoostPotential", "0.0")
        self.addComputeGlobal("RawTotalForceScalingFactor", "1.0")
        self.endBlock()
        self.addComputeGlobal("RawDeltaV", "boost_scale*(RawDihedralBoostPotential + RawTotalBoostPotential)")
        ...
        self.addComputeGlobal("TotalBoostPotential", "EffectiveScale*RawTotalBoostPotential")
        self.addComputeGlobal(
            "DihedralForceScalingFactor",
            "1 - EffectiveScale*(1 - RawDihedralForceScalingFactor)",
        )
        self.addComputeGlobal(
            "TotalForceScalingFactor",
            "1 - EffectiveScale*(1 - RawTotalForceScalingFactor)",
        )
        ...
        self.addComputeGlobal("DeltaV", "DihedralBoostPotential + TotalBoostPotential")
